...
The most successful amongst these incorporate a background model into the algorithm. Using a
background model to segregate the foreground and background is robust to realistic 
environments which may have some motion or noise. 
