...
\caption{Results of adaptive background subtraction algorithm in detecting a person in the frame
for data simulated by concatenating real recordings. TOP:
Mean temperature of frame over time. BOTTOM: Number of detected foreground pixels in each frame.
Gray regions mark the times when a person was in the frame.}
\end{figure}
